/* DO NOT FORGET TO ADD MORE MODULES IN THIS FAQ SECTION
EVERY INSTRUCTION SHOULD HAVE ITS OWN MODULE TO BE REFERENCEDD!!!*/

export default function FAQ() {
    return (
        <>
        <p>
        Setup Instructions Unboxing: 
...
●	Try connecting the keyboard to a different USB port. ● 	Restart your computer if necessary. 
Backlighting Not Working: 
●	Check if the backlight is disabled or set to a minimal brightness level. ● 	Verify that the configuration software is properly installed. 
Key Not Registering: 
